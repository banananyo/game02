...
public class E6 extends Enemy{
        ...
        if(e > 70) {
            ...
            switch (state) {
                ...
                case RUN_R:
                    ...
                    break;
                case DEAD_L:
                    if (!(spriteIndex >= 6 && spriteIndex <= 10)) {
                        spriteIndex = 6;
                    }
                    if (spriteIndex == 10) {
                    ...
                    break;
                case DEAD_R:
                    if (!(spriteIndex >= 11 && spriteIndex <= 15)) {
                        spriteIndex = 11;
                    }
                    if (spriteIndex == 15) {
                        state = State.DEADED_L;
    ...
    public E6(final World world, final float x, final float y, String name, int hp){
